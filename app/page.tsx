  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-black relative">
      ...
      <nav className="absolute top-0 right-0 left-0 z-[999] flex justify-end items-center px-4 sm:px-6 py-4 text-white">
        ...
        {/* Mobile menu */}
        {isMenuOpen && (
          <div className="absolute top-16 right-0 left-0 bg-black text-white flex flex-col items-center sm:hidden">
      ...
      {/* Hero Section */}
      <div className="relative z-10 container mx-auto px-4 sm:px-6 h-screen grid grid-cols-1 md:grid-cols-2 items-center">
          ...
          <div className="flex flex-col gap-6">
            <AnimatedContent distance={150} direction="horizontal" reverse={false} config={{ tension: 80, friction: 20 }} initialOpacity={0.2} animateOpacity scale={1.1} threshold={0.2}>
              <div className="flex flex-col items-start">
                ...
                <BlurText text="I am a fresh graduate in Information Systems with experience in system analysis and web application development. Lets Work With Me." delay={150} animateBy="words" direction="top" className="text-base sm:text-lg md:text-xl mb-8 text-white" />
              </div>
            </AnimatedContent>
          </div>
        </div>
    ...
    <section id="tech-skills" className="flex justify-center items-center min-h-screen py-24 px-4 sm:px-6 bg-black text-white">
      <div className="container mx-auto flex flex-col items-center">
        ...
        <BlurText text="Here are the programming languages, Tools, Frameworks, and Libraries that I am good at" delay={50} animateBy="words" direction="top" className="text-base sm:text-lg mb-8 text-white text-center" />
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-6 sm:gap-10 text-4xl sm:text-6xl">
        {[ 
            ...
            { icon: FaBootstrap, label: 'Bootstrap', color: 'text-info-500' }
